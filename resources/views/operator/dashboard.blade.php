        ...
        <div class="card shadow-sm border-0 h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="fw-bold fs-2 text-success" id="stat-sudah">
                        {{ $sudahAmbil }}
                    </div>
                </div>
        ...
        <div class="card shadow-sm border-0 h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="fw-bold fs-2 text-danger" id="stat-belum">
                        {{ $belumAmbil }}
                    </div>
                </div>
...
/*
|--------------------------------------------------------------------------
| Tambah baris ke tabel Riwayat + update statistik (tanpa reload)
|--------------------------------------------------------------------------
*/
function tambahRiwayat(nik, nama)
{
    ...
    const statSudah = document.getElementById('stat-sudah');
    const statBelum = document.getElementById('stat-belum');

    statSudah.innerText = parseInt(statSudah.innerText) + 1;
    statBelum.innerText = Math.max(0, parseInt(statBelum.innerText) - 1);
}

/*
|--------------------------------------------------------------------------
| Submit form konfirmasi via AJAX
|--------------------------------------------------------------------------
*/
